...
/**
 * Persistence bean post processor
 *
 * @author @jacob1182
 */
public class EntityProviderBeanPostProcessor implements BeanPostProcessor {
    ...
    private Object createEntityProviderProxy(Object target) {
        return createProxy(target, true, new EntityProviderAdvice(injectorHandler));
    }
}
